...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Copy and share", ""),
        ("Share as QR code", ""),
        ("Cannot build the QR code", ""),
        ("Scanning with OpenUU on a phone connects to this device.", ""),
        ...
        ("Move down", ""),
        ("Move up", ""),
        ("No online LAN helper has discovered this device", ""),
        ("Not available for this device", ""),
        ("Reorder", ""),
        ("Sign in on the target device first", ""),
        ("Wake request failed. Check your login and LAN helper.", ""),
        ("Wake requested. Wait for the device to come online; WOL and standby power are required.", ""),
        ("Wake service unavailable", ""),
        ("Wake through an online LAN device", ""),
        ("Wake up", ""),
        ("Files", ""),
        ("View only", ""),
        ("Port forwarding", ""),
