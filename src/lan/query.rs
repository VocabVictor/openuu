...
pub(super) fn get_mac_by_ip(ip: &IpAddr) -> ResultType<String> {
...
pub(super) fn get_ipaddr_by_peer<A: ToSocketAddrs>(peer: A) -> Option<IpAddr> {
...
pub(super) fn create_broadcast_sockets() -> Vec<UdpSocket> {
...
pub(super) fn send_query() -> ResultType<Vec<UdpSocket>> {
...
pub(super) fn spawn_wait_responses(sockets: Vec<UdpSocket>) -> UnboundedReceiver<config::DiscoveryPeer> {
...
pub(super) async fn handle_received_peers(mut rx: UnboundedReceiver<config::DiscoveryPeer>) -> ResultType<()> {
